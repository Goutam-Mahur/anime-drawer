...
Anime Drawer is a Next.js project that showcases an extensive collection of anime. It fetches data from the Shikimori API and implements infinite scrolling for a seamless user experience. This project utilizes Tailwind CSS for styling, providing a modern and responsive design.
